...
|[Кулакова Анна](https://github.com/kulakovaanna/mipt2024s-5-kulakova-a-d)| [git](https://github.com/kulakovaanna/mipt2024s-5-kulakova-a-d/tree/main/data) | наложение стиля |
|Малеванный Всеволод| |
...
# Отчетное
1. к 23:55 22 апреля публикуете в личном git pdf-отчет, представляющий текущие результаты вашей работы за семестр, факт публикации дублируете сообщением в группу (с ссылкой на документ) 
2. к 23:57 13 мая публикуете в git зачетный pdf-отчет, показывающий ваши достигнутые результаты, проведённые эксперименты и шаги по улучшению результатов, факт публикации дублируете сообщением в группу (с ссылкой на документ).
