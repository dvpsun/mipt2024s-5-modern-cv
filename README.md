...
[описание некоторых видов баркодов](barcode_types)
...
5. сделать минимальный pipeline для квадратных - проективная нормализация по разметке + декодирование OS декодерами (Артём)
